...
/**
 * Languages & Localization hub. Loads the language-settings singleton, the
 * language profiles (for the default-profile selector) and the TMDB
 * language/country catalogues used by the locale and region selects.
 */
